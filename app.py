...
class NLPApp:
    ...
    def login_gui(self):
        ...
        heading = Label(self.root,text='NLPApp',bg='#F3E9DC',fg='#C75D2C')
    ...
    def home_gui(self):
        ...
        language_btn = Button(self.root, text='Language Detection', width=30, height=4,command=self.language_gui)
    ...
    def sentiment_gui(self):
        ...
        heading2 = Label(self.root, text='Sentiment Analysis', bg='#F3E9DC', fg='#D96F32')
        ...
        self.sentiment_result = Label(self.root, text='',bg='#F3E9DC',fg='#D96F32')
    ...
    def ner_gui(self):
        ...
        heading2 = Label(self.root, text='Named Entity Recognition', bg='#F3E9DC', fg='#D96F32')
        heading2.pack(pady=(10, 20))
        heading2.configure(font=('verdana', 20))
        ...
        ner_btn = Button(self.root, text='Entity Extraction', command=self.do_ner)
        ner_btn.pack(pady=(10, 10))

        self.ner_result = Label(self.root, text='', bg='#F3E9DC', fg='#D96F32')
    ...
    def language_gui(self):
        ...
        heading2 = Label(self.root, text='Language Detection', bg='#F3E9DC', fg='#D96F32')
        heading2.pack(pady=(10, 20))
        heading2.configure(font=('verdana', 20))
        ...
        self.language_result = Label(self.root, text='', bg='#F3E9DC', fg='#D96F32')
